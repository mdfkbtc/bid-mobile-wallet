module.exports = {
  ...
  unlock: {
    title: 'Mở khóa ',
    touchID: 'Chạm ID cho “BlockIdCoin Wallet”',
  ...
  wallets: {
    ...
    walletModal: { btcv: 'BID', wallets: 'Ví' },
    importWallet: {
      title: 'Nhập ví của quý khách',
      header: 'Nhập ví',
      subtitle:
        'Viết ra đây những thông tin cần ghi nhớ, khóa riêng tư, WIF hoặc bất cứ thông tin gì quý khách có được. BlockIdCoinWallet tìm mọi cách để đoán đúng định dạng và nhập ví của quý khách.',
    ...
    import: {
      title: 'nhập',
      explanation:
        'Viết ra đây thông tin ghi nhớ, khóa riêng tư, WIF hoặc bất cứ thông tin gì quý khách có được. BlockIdCoinWallet tìm mọi cách để đoán đúng định dạng và nhập ví của quý khách.',
      imported: 'Đã nhập',
  ...
  send: {
    ...
    details: {
      ...
      address: 'địa chỉ',
      amount_placeholder: 'số tiền cần gửi (tính bằng BID)',
      fee_placeholder: 'cộng với phí giao dịch (tính bằng BID)',
  ...
  aboutUs: {
    ...
    rateBlockIdCoinWallet: 'Đánh giá BlockIdCoinWallet',
    goToOurGithub: 'Chuyển đến Github của chúng tôi',
    alwaysBackupYourKeys: 'Hãy luôn sao lưu mã khóa của quý khách',
    title: 'BlockIdCoinWallet là ví Cortez Vault miễn phí và mã nguồn mở. MIT được cấp phép.',
  },
  electrumServer: {
  ...
  selectLanguage: {
    header: 'Ngôn ngữ',
    restartInfo: 'Khi chọn ngôn ngữ mới, có thể cần khởi động lại BlockIdCoinWallet để thay đổi có hiệu lực',
