module.exports = {
  ...
  unlock: {
    title: 'Buka Kunci',
    touchID: 'Touch ID untuk "BlockIdCoin Wallet"',
  ...
  wallets: {
    ...
    walletModal: { btcv: 'BID', wallets: 'Dompet' },
    importWallet: {
      title: 'Impor dompet Anda',
      header: 'Impor dompet',
      subtitle:
        'Tuliskan di sini mnemonik, kunci privat, WIF, atau apa pun yang Anda punya. BlockIdCoinWallet akan berusaha sebaik mungkin untuk menebak format yang tepat dan mengimpor dompet Anda.',
  ...
  send: {
    ...
    details: {
      ...
      address: 'alamat',
      amount_placeholder: 'jumlah yang dikirimkan (dalam BID)',
      fee_placeholder: 'plus biaya transaksi (dalam BID)',
  ...
  aboutUs: {
    ...
    rateBlockIdCoinWallet: 'Beri peringkat BlockIdCoinWallet',
    goToOurGithub: 'Masuk ke Github kami',
    alwaysBackupYourKeys: 'Selalu cadangkan kunci Anda',
    title: 'BlockIdCoinWallet adalah dompet Cortez Vault gratis dan sumber terbuka. Dilisensi MIT.',
  },
  electrumServer: {
  ...
  selectLanguage: {
    header: 'Bahasa',
    restartInfo: 'Saat memilih bahasa baru, mungkin dibutuhkan pemulaian ulang BlockIdCoinWallet agar perubahan berlaku',
