module.exports = {
  ...
  wallets: {
    ...
    walletModal: { btcv: 'BID', wallets: 'ウォレット' },
    importWallet: {
      title: 'ご使用のウォレットをインポートする',
      header: 'ウォレットのインポート',
      subtitle:
        'ここにユーザーのニーモニック、秘密鍵、WIF、または取得したその他のものを入力してください。BlockIdCoinWalletでは、最善を尽くして、正しいフォーマットを推測し、ウォレットをインポートします。',
  ...
  send: {
    ...
    details: {
      ...
      address: 'アドレス',
      amount_placeholder: '（BIDの）送信する金額',
      fee_placeholder: '（BIDの）追加のトランザクション料金',
  ...
  aboutUs: {
    ...
    rateBlockIdCoinWallet: 'BlockIdCoinWalletを評価する',
  ...
  selectLanguage: {
    header: '言語',
    restartInfo: '新しい言語を選択したら、変更を有効にするために、BlockIdCoinWalletの再起動が必要な場合があります',
    confirmation: '確認',
    confirm: '確認する',
