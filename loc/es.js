module.exports = {
  ...
  unlock: {
    title: 'Desbloquear',
    touchID: 'Touch ID para «BlockIdCoin Wallet»',
  ...
  wallets: {
    ...
    walletModal: { btcv: 'BID', wallets: 'Monederos' },
    importWallet: {
      title: 'Importe su monedero',
      header: 'Importar monedero',
      subtitle:
        'Escriba aquí su frase mnemotécnica, clave privada, WIF o cualquier dato que tenga. BlockIdCoinWallet hará todo lo posible para adivinar el formato correcto e importar su monedero.',
    ...
    import: {
      title: 'importar',
      explanation:
        'Escriba aquí su clave mnemotécnica privada, WIF o cualquier cosa que tenga. BlockIdCoinWallet hará todo lo posible para adivinar el formato correcto e importar su monedero',
      imported: 'Importado',
  ...
  send: {
    ...
    details: {
      ...
      address: 'dirección',
      amount_placeholder: 'cantidad a enviar (en BID)',
      fee_placeholder: 'más la comisión de transacción (en BID)',
  ...
  aboutUs: {
    ...
    rateBlockIdCoinWallet: 'Valorar BlockIdCoinWallet',
    goToOurGithub: 'Acceda a nuestro Github',
    alwaysBackupYourKeys: 'Siempre guarde una copia de seguridad de sus claves',
    title: 'BlockIdCoin Wallet es un monedero de Cortez Vault gratuito y de código abierto. Con licencia MIT.',
  },
  electrumServer: {
  ...
  selectLanguage: {
    header: 'Idioma',
    restartInfo:
      'Al seleccionar un nuevo idioma, puede ser necesario reiniciar BlockIdCoinWallet para que el cambio surta efecto',
