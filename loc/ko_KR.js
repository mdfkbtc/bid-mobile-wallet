module.exports = {
  ...
  wallets: {
    ...
    walletModal: { btcv: 'BID', wallets: '지갑' },
    importWallet: {
      title: '귀하의 지갑 가져오기',
      header: '지갑 가져오기',
      subtitle:
        '연상 기호, 개인 키, WIF 또는 가지고 있는 것을 여기에 쓰십시오. 골드월렛(BlockIdCoinWallet)은 올바른 형식을 추측하고 지갑을 가져오기 위해 최선을 다합니다.',
  ...
  send: {
    ...
    details: {
      ...
      address: '주소',
      amount_placeholder: '보낼 금액(BID)',
      fee_placeholder: '추가 트랜잭션 수수료(BID)',
  ...
  aboutUs: {
    ...
    rateBlockIdCoinWallet: '골드월렛(BlockIdCoinWallet) 평가하기',
    goToOurGithub: '당사의 Github로 이동하기',
    alwaysBackupYourKeys: '항상 키를 백업하십시오',
    title: '골드월렛(BlockIdCoinWallet)은 무료이며 오픈 소스인 비트코인 볼트(Cortez Vault) 지갑입니다. 허가받은 MIT.',
  },
  electrumServer: {
  ...
  selectLanguage: {
    header: '언어',
    restartInfo: '새로운 언어를 선택할 때 변경 사항을 적용하려면 골드월렛(BlockIdCoinWallet)을 다시 시작해야 할 수 있습니다',
    confirmation: '확인',
    confirm: '확인',
