module.exports = {
  ...
  wallets: {
    ...
    walletModal: { btcv: 'BID', wallets: 'Carteiras' },
    importWallet: {
      title: 'Importar a sua carteira',
      header: 'Importar carteira',
      subtitle:
        'Anote aqui a sua mnemónica, chave privada, WIF ou o que tiver. BlockIdCoinWallet fará o melhor para descobrir o formato correto e importar a sua carteira',
  ...
  send: {
    ...
    details: {
      ...
      address: 'endereço',
      amount_placeholder: 'montante a enviar (em BID)',
      fee_placeholder: 'mais taxa da transacção (em BID)',
  ...
  aboutUs: {
    ...
    rateBlockIdCoinWallet: 'Classificar BlockIdCoinWallet',
    goToOurGithub: 'Ir para Github',
    alwaysBackupYourKeys: 'Realizar sempre uma cópia de segurança nas suas chaves',
    title: 'A BlockIdCoin Wallet é grátis, tratando-se de uma carteira gratuita do Cortez Vault. Licenciada pelo MIT.',
  },
  electrumServer: {
  ...
  selectLanguage: {
    header: 'Idioma',
    restartInfo:
      'Quando um novo idioma é seleccionado, o reinício da aplicação BlockIdCoinWallet pode ser exigido para esta alteração ter efeito',
