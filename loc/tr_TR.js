module.exports = {
  ...
  unlock: {
    title: 'Kilidi Aç',
    touchID: '"BlockIdCoin Wallet" için Touch ID',
  ...
  wallets: {
    ...
    walletModal: { btcv: 'BID', wallets: 'Cüzdanlar' },
    importWallet: {
      title: 'Cüzdanınızı içeri aktarın',
      header: 'Cüzdanı içeri aktar',
      subtitle:
        'Buraya hatırlatıcı ipucunuzu, özel anahtarınızı, WIF’ı veya sahip olduğunuz başka bir şeyi yazın. BlockIdCoinWallet doğru biçimi tahmin etmek ve cüzdanınızı içeri aktarmak için elinden geleni yapacak.',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adres',
      amount_placeholder: 'gönderilecek tutar (BID cinsinden)',
      fee_placeholder: 'artı işlem ücreti (BID cinsinden)',
  ...
  aboutUs: {
    ...
    rateBlockIdCoinWallet: 'BlockIdCoinWallet’ı Puanla',
    goToOurGithub: 'Github’umuza Git',
    alwaysBackupYourKeys: 'Her zaman anahtarlarınızı yedekleyin',
    title: 'BlockIdCoin Wallet ücretsiz ve açık kaynaklı bir Cortez Vault cüzdanıdır. Lisanslı MIT.',
  },
  electrumServer: {
  ...
  selectLanguage: {
    header: 'Dil',
    restartInfo:
      'Yeni bir dil seçerken BlockIdCoinWallet’ı yeniden başlatmak değişikliğin geçerli olması için gerekli olabilir',
    confirmation: 'Onay',
    confirm: 'Onayla',
