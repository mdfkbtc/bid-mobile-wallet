...
import { HDLegacyP2PKHWallet, LegacyWallet, HDSegwitP2SHWallet, LightningCustodianWallet, AppStorage } from '../../class';
                ...
                return (
                  <View>
                    ...
                    <BlueListItem
                      ...
                      bottomDivider={false}
                      onPress={() => {
                        this.onSelect(0, HDLegacyP2PKHWallet.type);
                      }}
                    ...
                    <BlueListItem
                      ...
                      bottomDivider={false}
                      onPress={() => {
                        this.onSelect(1, LegacyWallet.type);
                      }}
