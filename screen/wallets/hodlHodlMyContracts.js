          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalContentCentered}>
              <View style={styles.statusGrayWrapper2}>
                <Text
                  ...
                  onPress={() => Linking.openURL(`https://bid.cryptoscope.cc/address/?address=${this.state.contractToDisplay.release_address}`)}
                >
            ...
            <View style={styles.modalContentCentered}>
              <View style={styles.statusGrayWrapper2}>
                <Text
                  style={styles.statusGrayText2}
                  onPress={() => Linking.openURL(`https://bid.cryptoscope.cc/address/?address=${this.state.contractToDisplay.escrow.address}`)}
                >
